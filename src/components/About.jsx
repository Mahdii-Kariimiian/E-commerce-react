    ...
    return (
        <div className="text-text bg-background h-screen p-10">
            <div className="lg:w-[50%]">
                ...
                <p className="mb-5">
                    While this site is primarily a practice exercise, it simulates
                    the experience of browsing and shopping for products online.
                    Users can explore a range of products, add items to their cart,
                    adjust quantities, and proceed to checkout. Learning and Skill
                    Development.
                </p>
